...
3. [Blogs](#blogs)
4. [Books](#books)
5. [Build Your Own Dl Machine](#build-your-own-dl-machine)
...
1. [Zero to Singularity](https://www.zerotosingularity.com/)
...
1. [Deeplearning.net / Datasets](http://deeplearning.net/datasets/)
2. [Google Street View House Numbers (SVHN)](http://ufldl.stanford.edu/housenumbers/)
...
2. [Probability and Statistics for Programmers](http://www.greenteapress.com/thinkstats/)
3. [Probabilistic Programming & Bayesian Methods for Hackers](http://camdavidsonpilon.github.io/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers/)
4. [Understanding Machine Learning: from Theory to Algorithms](http://www.cs.huji.ac.il/~shais/UnderstandingMachineLearning/)
5. [Elements of statistical learning](https://web.stanford.edu/~hastie/ElemStatLearn/)
6. [An introduction to statistical learning](http://www-bcf.usc.edu/~gareth/ISL/)
7. [Foundations of data science](https://www.cs.cornell.edu/jeh/book.pdf)
...
1. [Machine Learning- Coursera - Andrew Ng](https://www.coursera.org/learn/machine-learning/)
2. [Deep Learning Specialization - Coursera](https://www.deeplearning.ai/)
3. [Advanced Machine Learning Specialization - Coursera](https://www.coursera.org/specializations/aml)
4. [Fast.ai](http://www.fast.ai/)
5. [Deep Learning Udacity](https://classroom.udacity.com/courses/ud730)
6. [MIT 6.S094: Deep Learning for Self-Driving Cars](https://selfdrivingcars.mit.edu/)
7. [6.S191: Introduction to Deep Learning](http://introtodeeplearning.com/)
...
5. [Visualizing and Understanding Convolutional Networks](https://arxiv.org/abs/1311.2901)
...
8. [MobileNets: Efficient Convolutional Neural Networks for Mobile Vision Applications](https://arxiv.org/abs/1704.04861)
...
12. [Generative Reversible Networks](https://arxiv.org/abs/1806.01610)
13. [Patch-Based Image Inpainting with Generative Adversarial Networks](https://arxiv.org/abs/1803.07422)
...
1. [Fast.ai - Lesson 1](http://course.fast.ai/lessons/lesson1.html)
...
2. [Fast.ai - Lesson 2](http://course.fast.ai/lessons/lesson2.html)
...
3. [Fast.ai - Lesson 3](http://course.fast.ai/lessons/lesson3.html)
...
4. [Fast.ai - Lesson 4](http://course.fast.ai/lessons/lesson4.html)
...
5. [Fast.ai - Lesson 5](http://course.fast.ai/lessons/lesson5.html)
...
6. [Fast.ai - Lesson 6](http://course.fast.ai/lessons/lesson6.html)
